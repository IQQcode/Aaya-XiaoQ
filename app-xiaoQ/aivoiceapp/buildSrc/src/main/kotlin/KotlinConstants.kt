...
object DependenciesConfig {
    ...
    // GradientLayout
    const val GRADIENT_LAYOUT = "net.colindodd:gradientlayout:1.2"

    // ConstraintLayout
    const val CONSTRAINT_LAYOUT = "androidx.constraintlayout:constraintlayout:2.0.1"

    // ArcSeekBar(圆弧拖动条)
    const val ARC_SEEKBAR = "com.gcssloop.widget:arc-seekbar:1.7.0"
}
...
object ModuleConfig {
    ...
    const val MODULE_CHAT = "com.imooc.module_chat"
}
